微信在 2016 年9月21日发布的小程序内测版，今天（2016年11月3日）发布了公测版，我司拿到了内测资格，在这段时间我们完成了微信小程序的开发，中间遇到了一些问题，也有一些思考，下面我会从微信支付、公众平台的迭代、微信生态系统、Open Web 和开发者这几个角度来分析一下微信小程序。首先看一下什么是小程序。
